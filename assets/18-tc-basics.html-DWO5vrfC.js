import{_ as n,c as e,d as o,o as r}from"./app-BsKQU4X_.js";const l={};function a(s,t){return r(),e("div",null,t[0]||(t[0]=[o(`<h1 id="task-controller-tc-기초" tabindex="-1"><a class="header-anchor" href="#task-controller-tc-기초"><span>Task Controller (TC) 기초</span></a></h1><h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>Task Controller(TC)가 정밀 농업에서 담당하는 역할을 설명할 수 있다.</li><li>TC-Server와 TC-Client의 차이를 구분하고 각각의 위치를 식별할 수 있다.</li><li>Section Control과 Rate Control의 목적과 동작 원리를 비교할 수 있다.</li><li>GPS 위치 데이터가 TC 제어에 어떻게 활용되는지 설명할 수 있다.</li></ul><hr><h2 id="_1-tc란-무엇인가" tabindex="-1"><a class="header-anchor" href="#_1-tc란-무엇인가"><span>1. TC란 무엇인가</span></a></h2><p><strong>Task Controller(TC)</strong>는 ISO 11783-10에 정의된 정밀 농업의 핵심 컴포넌트이다.</p><blockquote><p><strong>ISO 11783 Part 10 — Task Controller and Management Information System Data Interchange</strong></p></blockquote><p>TC는 두 가지 핵심 기능을 수행한다.</p><ul><li><strong>자동 제어</strong>: 작업 계획(처방 맵, Prescription Map)에 따라 작업기를 자동으로 제어한다. 밭의 위치별로 미리 지정된 살포량·파종량을 GPS 위치와 연동하여 자동으로 적용한다.</li><li><strong>작업 기록</strong>: 실제 작업 결과(As-Applied Data)를 수집하고 기록한다. 어느 위치에서 얼마나 살포했는지를 나중에 분석할 수 있도록 로그로 남깁니다.</li></ul><p>TC가 없던 시대에는 농민이 수동으로 살포량을 조절해야 했다. TC는 이 과정을 자동화하여 비료·농약 과용을 줄이고 생산성을 높이다.</p><hr><h2 id="_2-tc의-역할" tabindex="-1"><a class="header-anchor" href="#_2-tc의-역할"><span>2. TC의 역할</span></a></h2><p>TC는 FMIS(Farm Management Information System, 농장관리시스템)와 작업기 사이를 연결하는 중간 다리이다.</p><pre class="mermaid">flowchart TD
    FMIS[&quot;FMIS\\n(농장관리시스템)&quot;]
    TC[&quot;TC\\n(Task Controller)&quot;]
    ECU[&quot;작업기 ECU\\n(TC-Client)&quot;]
    LOG[&quot;작업 로그\\n(As-Applied)&quot;]
