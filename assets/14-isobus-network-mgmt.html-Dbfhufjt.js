...
</pre><h2 id="_2-working-set" tabindex="-1"><a class="header-anchor" href="#_2-working-set"><span>2. Working Set</span></a></h2><p>작업기(Implement)는 내부에 여러 ECU를 포함할 수 있다. 예를 들어 파종기(Seeder)는 메인 제어 ECU, 섹션 밸브 ECU, 속도 센서 ECU를 각각 가질 수 있다. 이 ECU들을 하나의 논리적 단위로 묶는 것이 <strong>Working Set</strong>이다.</p><h3 id="마스터-멤버-관계" tabindex="-1"><a class="header-anchor" href="#마스터-멤버-관계"><span>마스터-멤버 관계</span></a></h3><pre class="mermaid">graph TD
...
</pre><h3 id="fmi-주요-값" tabindex="-1"><a class="header-anchor" href="#fmi-주요-값"><span>FMI 주요 값</span></a></h3><table><thead><tr><th>FMI</th><th>의미</th></tr></thead><tbody><tr><td>0</td><td>데이터 유효 범위 초과 (높음)</td></tr><tr><td>1</td><td>데이터 유효 범위 초과 (낮음)</td></tr><tr><td>2</td><td>데이터 불안정 / 간헐적</td></tr><tr><td>3</td><td>전압 높음 / 단락 (High)</td></tr><tr><td>4</td><td>전압 낮음 / 단락 (Low)</td></tr><tr><td>5</td><td>전류 낮음 / 단선</td></tr><tr><td>6</td><td>전류 높음 / 단락 (GND)</td></tr><tr><td>12</td><td>고장 모드 불명확</td></tr><tr><td>19</td><td>수신 네트워크 데이터 오류</td></tr></tbody></table><h2 id="_4-네트워크-관리-타임라인" tabindex="-1"><a class="header-anchor" href="#_4-네트워크-관리-타임라인"><span>4. 네트워크 관리 타임라인</span></a></h2><p>전원을 켠 순간부터 ISOBUS 통신이 완전히 확립될 때까지의 시간 흐름이다.</p><pre class="mermaid">gantt
