    ...
    <div class="project-item">
      ...
      <div class="project-details">
        ...
        <ul>
          ...
          <li>핵심 서비스에 SLO를 정의하고, RED(Rate·Errors·Duration) 골든 시그널 기준으로 대시보드를 표준화해 모니터 재설계, 행동으로 이어지지 않는 오탐 알림 정리</li>
          <li>GitHub Actions·ArgoCD 이벤트로 DORA 4지표(리드타임·배포빈도·변경실패율·MTTR)를 계측·대시보드화해 배포 성과를 정량 추적</li>
        ...
        <ul>
          ...
          <li>RED 골든 시그널 대시보드 표준화, DORA 4지표 가시화로 배포 성과 추적</li>
