import{_ as e,c as d,d as n,o as s}from"./app-D0l-hTxU.js";const a={};function r(l,t){return s(),d("div",null,t[0]||(t[0]=[n(`<h1 id="j1939-주소-체계" tabindex="-1"><a class="header-anchor" href="#j1939-주소-체계"><span>J1939 주소 체계</span></a></h1><h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>소스 주소(SA)의 범위와 예약 주소의 의미를 설명할 수 있다.</li><li>64비트 NAME의 각 필드 구성과 역할을 이해한다.</li><li>주소 클레임 절차의 단계별 흐름과 충돌 해결 방식을 설명할 수 있다.</li><li>Commanded Address(PGN 65240)의 동작 원리를 이해한다.</li></ul><hr><h2 id="_1-소스-주소-sa" tabindex="-1"><a class="header-anchor" href="#_1-소스-주소-sa"><span>1. 소스 주소 (SA)</span></a></h2><p>J1939 네트워크에서 모든 ECU는 <strong>소스 주소(Source Address, SA)</strong>를 가집니다. SA는 8비트 값으로, 29비트 CAN ID의 <strong>하위 8비트(비트 7~0)</strong>에 위치한다.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">┌─────────────────────────────────────────────────┐</span>
...
</pre><h3 id="사용-사례" tabindex="-1"><a class="header-anchor" href="#사용-사례"><span>사용 사례</span></a></h3><table><thead><tr><th>상황</th><th>설명</th></tr></thead><tbody><tr><td>공장 설정</td><td>제조 라인에서 장치에 고정 SA 부여</td></tr><tr><td>네트워크 재구성</td><td>시스템 통합 시 주소 충돌 사전 방지</td></tr><tr><td>진단/유지보수</td><td>특정 SA로 장치를 강제 이동</td></tr></tbody></table><p>Commanded Address를 수신한 ECU는 반드시 <strong>Address Claimed 메시지로 응답</strong>해야 한다. ECU가 새 주소를 클레임할 수 없는 경우 Cannot Claim을 전송한다.</p><hr><div class="hint-container tip"><p class="hint-container-title">핵심 정리</p><ul><li>SA는 8비트이며 0~253이 일반 사용 가능, 254=Null, 255=Global(브로드캐스트)이다.</li><li>SA는 29비트 CAN ID의 하위 8비트에 위치한다.</li><li>NAME은 64비트 구조체로 장치를 전 세계적으로 고유 식별하며, <strong>값이 작을수록 우선순위가 높다.</strong></li><li>주소 클레임(PGN 60928)은 전원 ON 후 발생하며, 충돌 시 NAME 비교로 승자를 결정한다.</li><li>AAC=1인 장치는 충돌 패배 후 다른 주소로 자동 재클레임할 수 있다.</li><li>Commanded Address(PGN 65240)는 외부에서 ECU의 주소를 강제 지정하는 방법이다.</li></ul></div><h2 id="다음-챕터" tabindex="-1"><a class="header-anchor" href="#다음-챕터"><span>다음 챕터</span></a></h2><p><a href="/study/isobus/11-j1939-transport">J1939 Transport Protocol</a>으로 이어집니다.</p>`,43)]))}const o=e(a,[["render",r],["__file","10-j1939-address.html.vue"]]),h=JSON.parse('{"path":"/study/isobus/10-j1939-address.html","title":"J1939 주소 체계","lang":"en-US","frontmatter":{"title":"J1939 주소 체계","description":"J1939의 소스 주소(SA), 64비트 NAME, 주소 클레임 절차, Commanded Address를 이해한다.","date":"2026-04-13T00:00:00.000Z","tags":["ISOBUS","J1939","CAN","주소","NAME"],"prev":"/study/isobus/09-j1939-message","next":"/study/isobus/11-j1939-transport"},"headers":[{"level":1,"title":"J1939 주소 체계","slug":"j1939-주소-체계","link":"#j1939-주소-체계","children":[{"level":2,"title":"학습 목표","slug":"학습-목표","link":"#학습-목표","children":[]},{"level":2,"title":"1. 소스 주소 (SA)","slug":"_1-소스-주소-sa","link":"#_1-소스-주소-sa","children":[{"level":3,"title":"SA 값 범위","slug":"sa-값-범위","link":"#sa-값-범위","children":[]},{"level":3,"title":"예약된 주소 (일부)","slug":"예약된-주소-일부","link":"#예약된-주소-일부","children":[]}]},{"level":2,"title":"2. NAME (64비트)","slug":"_2-name-64비트","link":"#_2-name-64비트","children":[{"level":3,"title":"NAME 필드 구성","slug":"name-필드-구성","link":"#name-필드-구성","children":[]}]},{"level":2,"title":"3. 주소 클레임 절차","slug":"_3-주소-클레임-절차","link":"#_3-주소-클레임-절차","children":[{"level":3,"title":"절차 단계 요약","slug":"절차-단계-요약","link":"#절차-단계-요약","children":[]},{"level":3,"title":"타이밍 규칙","slug":"타이밍-규칙","link":"#타이밍-규칙","children":[]}]},{"level":2,"title":"4. Commanded Address","slug":"_4-commanded-address","link":"#_4-commanded-address","children":[{"level":3,"title":"메시지 구조","slug":"메시지-구조","link":"#메시지-구조","children":[]},{"level":3,"title":"동작 방식","slug":"동작-방식","link":"#동작-방식","children":[]},{"level":3,"title":"사용 사례","slug":"사용-사례","link":"#사용-사례","children":[]}]},{"level":2,"title":"다음 챕터","slug":"다음-챕터","link":"#다음-챕터","children":[]}]}],"git":{},"filePathRelative":"_study/isobus/10-j1939-address.md"}');export{o as comp,h as data};
