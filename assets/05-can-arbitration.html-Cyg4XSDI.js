...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Priority 0이 가장 높고, Priority 7이 가장 낮다. 이를 통해 메시지 종류별 우선순위를 명시적으로 설정할 수 있다.</p><hr><h2 id="_4-메시지-설계-시-고려사항" tabindex="-1"><a class="header-anchor" href="#_4-메시지-설계-시-고려사항"><span>4. 메시지 설계 시 고려사항</span></a></h2><p>중재 메커니즘을 이해하면 <strong>ID 배정 전략</strong>이 명확해진다.</p><p><strong>안전 관련 메시지에는 낮은 ID를 배정</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Priority 0 (ID 앞자리 000): 브레이크, 조향, 비상 정지</span>
