import{_ as e,c as n,d as a,o as r}from"./app-CJC3hE05.js";const d={};function l(s,t){return r(),n("div",null,t[0]||(t[0]=[a(`<h1 id="tc-프로세스-데이터" tabindex="-1"><a class="header-anchor" href="#tc-프로세스-데이터"><span>TC 프로세스 데이터</span></a></h1><h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>DDI(Data Dictionary Identifier)의 의미와 주요 번호를 설명할 수 있다.</li><li>Device Element의 타입과 역할을 구분할 수 있다.</li><li>Value Command와 Process Data Value의 흐름을 시퀀스 다이어그램으로 그릴 수 있다.</li><li>Measurement와 Setpoint의 차이를 이해하고 제어 오차의 개념을 설명할 수 있다.</li><li>살포량 제어 시나리오를 통해 전체 프로세스 데이터 흐름을 추적할 수 있다.</li></ul><hr><h2 id="_1-ddi-data-dictionary-identifier" tabindex="-1"><a class="header-anchor" href="#_1-ddi-data-dictionary-identifier"><span>1. DDI (Data Dictionary Identifier)</span></a></h2><p><strong>DDI</strong>는 TC 프로세스 데이터 항목을 구분하는 표준화된 16비트 번호입니다.</p><blockquote><p>DDI는 &quot;어떤 종류의 데이터인가&quot;를 나타냅니다. 살포량인지, 속도인지, 면적인지를 숫자로 표현합니다.</p></blockquote><p>모든 TC 메시지는 DDI를 포함하여 어떤 데이터를 주고받는지 명시합니다. 주요 DDI는 다음과 같습니다.</p><table><thead><tr><th>DDI</th><th>이름</th><th>방향</th><th>설명</th></tr></thead><tbody><tr><td><strong>1</strong></td><td>Setpoint Volume Per Area</td><td>TC → 작업기</td><td>목표 살포량 (L/ha, ml/m²)</td></tr><tr><td><strong>2</strong></td><td>Actual Volume Per Area</td><td>작업기 → TC</td><td>실제 살포량 (센서 측정)</td></tr><tr><td><strong>7</strong></td><td>Setpoint Volume Per Time</td><td>TC → 작업기</td><td>시간당 목표 유량 (L/min)</td></tr><tr><td><strong>8</strong></td><td>Actual Volume Per Time</td><td>작업기 → TC</td><td>시간당 실제 유량</td></tr><tr><td><strong>73</strong></td><td>Setpoint Mass Per Area</td><td>TC → 작업기</td><td>목표 살포 질량 (kg/ha)</td></tr><tr><td><strong>74</strong></td><td>Actual Mass Per Area</td><td>작업기 → TC</td><td>실제 살포 질량</td></tr><tr><td><strong>141</strong></td><td>Section Control State</td><td>TC → 작업기</td><td>구획 ON/OFF 상태</td></tr></tbody></table><p>전체 DDI 목록은 <a href="https://www.isobus.net/isobus/dDI" target="_blank" rel="noopener noreferrer">isobus.net</a>에서 확인할 수 있습니다. 현재 약 600개 이상의 DDI가 정의되어 있습니다.</p><hr><h2 id="_2-element" tabindex="-1"><a class="header-anchor" href="#_2-element"><span>2. Element</span></a></h2><p><strong>Device Element(DeviceElement)</strong>는 작업기의 논리적 구성 단위입니다. 물리적 장치를 계층적으로 표현합니다.</p><h3 id="element-type" tabindex="-1"><a class="header-anchor" href="#element-type"><span>Element Type</span></a></h3><table><thead><tr><th>타입</th><th>설명</th><th>예시</th></tr></thead><tbody><tr><td><strong>Device</strong></td><td>전체 장치 (최상위)</td><td>살포기 전체</td></tr><tr><td><strong>Function</strong></td><td>기능 단위</td><td>살포 펌프, 교반기</td></tr><tr><td><strong>Bin</strong></td><td>저장 용기</td><td>약액 탱크, 비료 빈</td></tr><tr><td><strong>Section</strong></td><td>분할 구획</td><td>붐 스프레이어의 좌/우 섹션</td></tr><tr><td><strong>Connector</strong></td><td>연결 포인트</td><td>히치 연결부</td></tr><tr><td><strong>Navigation Reference</strong></td><td>위치 기준점</td><td>GPS 안테나 기준 작업 위치 오프셋</td></tr></tbody></table><p>각 Element는 <strong>Element Number</strong>로 식별됩니다. 예를 들어, Section 1은 Element Number 1, Section 2는 Element Number 2로 구분됩니다.</p><pre class="mermaid">graph TD
...
</pre><h3 id="pgn-0x00cb00-메시지-구조" tabindex="-1"><a class="header-anchor" href="#pgn-0x00cb00-메시지-구조"><span>PGN 0x00CB00 메시지 구조</span></a></h3><p>Process Data 메시지의 데이터 필드는 다음과 같이 구성됩니다.</p><table><thead><tr><th>바이트</th><th>필드</th><th>설명</th></tr></thead><tbody><tr><td>0</td><td>Command/Response</td><td>명령(0xA) 또는 응답 구분</td></tr><tr><td>1–2</td><td>DDI</td><td>데이터 항목 번호 (16비트)</td></tr><tr><td>3–4</td><td>Element Number</td><td>대상 Element 번호</td></tr><tr><td>5–8</td><td>Value</td><td>32비트 정수 값</td></tr></tbody></table><hr><h2 id="_4-measurement-setpoint" tabindex="-1"><a class="header-anchor" href="#_4-measurement-setpoint"><span>4. Measurement / Setpoint</span></a></h2><p>TC 프로세스 데이터는 크게 두 가지로 구분됩니다.</p><table><thead><tr><th>구분</th><th>생성 주체</th><th>방향</th><th>의미</th></tr></thead><tbody><tr><td><strong>Setpoint</strong></td><td>TC-Server</td><td>TC → 작업기</td><td>TC가 처방 맵에서 조회한 목표 값</td></tr><tr><td><strong>Measurement</strong></td><td>작업기 센서</td><td>작업기 → TC</td><td>작업기가 실제로 측정한 값</td></tr></tbody></table><pre class="mermaid">graph LR
    ...
    SP --- ERR[&quot;제어 오차\\n200 - 198 = 2 L/ha&quot;]
    MS --- ERR
</pre><p><strong>제어 오차(Control Error)</strong> = Setpoint − Measurement</p><p>작업기의 제어 시스템은 이 오차를 최소화하도록 밸브 개도량, 펌프 속도 등을 조절합니다. TC는 오차가 허용 범위를 벗어나면 알람을 발생시킬 수 있습니다.</p><hr><h2 id="_5-프로세스-데이터-흐름-실습" tabindex="-1"><a class="header-anchor" href="#_5-프로세스-데이터-흐름-실습"><span>5. 프로세스 데이터 흐름 실습</span></a></h2><h3 id="시나리오-gps-기반-살포량-제어" tabindex="-1"><a class="header-anchor" href="#시나리오-gps-기반-살포량-제어"><span>시나리오: GPS 기반 살포량 제어</span></a></h3><p>트랙터가 밭을 주행하면서 위치에 따라 비료 살포량을 자동으로 조절하는 시나리오입니다.</p><p><strong>조건</strong></p><ul><li>처방 맵: 구역 A = 200 L/ha, 구역 B = 150 L/ha</li><li>살포기: 3구획, 각 3m 폭 (총 9m)</li><li>DDI 1: Setpoint Volume Per Area / DDI 2: Actual Volume Per Area</li></ul><pre class="mermaid">sequenceDiagram
