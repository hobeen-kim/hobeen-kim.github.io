import{_ as d,c as o,a as l,d as n,e as u,b as s,r as i,o as p,f as a}from"./app-CklQUnYn.js";const c="/images/study-isobus/08-canid-fields-light.png",g="/images/study-isobus/08-canid-fields-dark.png",A="/images/study-isobus/08-canid-example-light.png",b="/images/study-isobus/08-canid-example-dark.png",h={},S={class:"table-of-contents"};function v(m,t){const r=i("Header"),e=i("router-link");return p(),o("div",null,[l(r),n("nav",S,[n("ul",null,[n("li",null,[l(e,{to:"#_1-왜-can만으로는-부족한가"},{default:s(()=>t[0]||(t[0]=[a("1. 왜 CAN만으로는 부족한가")])),_:1}),n("ul",null,[n("li",null,[l(e,{to:"#can은-데이터-전달만-담당한다"},{default:s(()=>t[1]||(t[1]=[a("CAN은 데이터 전달만 담당한다")])),_:1})]),n("li",null,[l(e,{to:"#택배-트럭과-물류-시스템-비유"},{default:s(()=>t[2]||(t[2]=[a("택배 트럭과 물류 시스템 비유")])),_:1})])])]),n("li",null,[l(e,{to:"#_2-상위-프로토콜-지도"},{default:s(()=>t[3]||(t[3]=[a("2. 상위 프로토콜 지도")])),_:1}),n("ul",null,[n("li",null,[l(e,{to:"#osi-7계층에서의-위치"},{default:s(()=>t[4]||(t[4]=[a("OSI 7계층에서의 위치")])),_:1})]),n("li",null,[l(e,{to:"#프로토콜별-적용-도메인"},{default:s(()=>t[5]||(t[5]=[a("프로토콜별 적용 도메인")])),_:1})])])]),n("li",null,[l(e,{to:"#_3-j1939이란"},{default:s(()=>t[6]||(t[6]=[a("3. J1939이란")])),_:1})]),n("li",null,[l(e,{to:"#_4-j1939과-can의-관계"},{default:s(()=>t[7]||(t[7]=[a("4. J1939과 CAN의 관계")])),_:1}),n("ul",null,[n("li",null,[l(e,{to:"#_29비트-can-id의-구조화"},{default:s(()=>t[8]||(t[8]=[a("29비트 CAN ID의 구조화")])),_:1})]),n("li",null,[l(e,{to:"#_29비트-id-예시-해석"},{default:s(()=>t[9]||(t[9]=[a("29비트 ID 예시 해석")])),_:1})])])]),n("li",null,[l(e,{to:"#_5-j1939-네트워크-구성"},{default:s(()=>t[10]||(t[10]=[a("5. J1939 네트워크 구성")])),_:1}),n("ul",null,[n("li",null,[l(e,{to:"#소스-어드레스-sa-할당"},{default:s(()=>t[11]||(t[11]=[a("소스 어드레스(SA) 할당")])),_:1})]),n("li",null,[l(e,{to:"#네트워크-토폴로지-예시"},{default:s(()=>t[12]||(t[12]=[a("네트워크 토폴로지 예시")])),_:1})]),n("li",null,[l(e,{to:"#j1939-통신-흐름-예시"},{default:s(()=>t[13]||(t[13]=[a("J1939 통신 흐름 예시")])),_:1})]),n("li",null,[l(e,{to:"#다음-챕터"},{default:s(()=>t[14]||(t[14]=[a("다음 챕터")])),_:1})])])])])]),t[15]||(t[15]=u(`<div class="hint-container info"><p class="hint-container-title">학습 목표</p><ul><li>CAN만으로 부족한 이유를 상위 프로토콜의 필요성과 연결해서 설명할 수 있다.</li><li>CANopen, DeviceNet, J1939, ISOBUS의 위치와 차이를 구분할 수 있다.</li><li>J1939의 29비트 CAN ID 구조(Priority, EDP, DP, PF, PS, SA)를 해석할 수 있다.</li><li>J1939 네트워크에서 소스 어드레스(SA)의 역할을 이해한다.</li></ul></div><h1 id="_1-왜-can만으로는-부족한가" tabindex="-1"><a class="header-anchor" href="#_1-왜-can만으로는-부족한가"><span>1. 왜 CAN만으로는 부족한가</span></a></h1><h2 id="can은-데이터-전달만-담당한다" tabindex="-1"><a class="header-anchor" href="#can은-데이터-전달만-담당한다"><span>CAN은 데이터 전달만 담당한다</span></a></h2><p>CAN 프로토콜은 물리 계층과 데이터 링크 계층만 정의한다. 메시지를 버스에 올리고 내리는 것, 에러를 감지하는 것 — 여기까지가 CAN이 하는 일이다.</p><p>다음 기능들은 CAN 규격 어디에도 없다.</p><table><thead><tr><th>필요 기능</th><th>CAN 2.0 지원 여부</th></tr></thead><tbody><tr><td>노드별 고유 주소 관리</td><td>없음 (29비트 ID를 자유롭게 사용)</td></tr><tr><td>메시지 의미 해석 (온도, 압력 등)</td><td>없음</td></tr><tr><td>8바이트 초과 데이터 전송 프로토콜</td><td>없음</td></tr><tr><td>네트워크 진단 / 장치 검색</td><td>없음</td></tr><tr><td>타임아웃, 재전송 정책</td><td>없음</td></tr></tbody></table><h2 id="택배-트럭과-물류-시스템-비유" tabindex="-1"><a class="header-anchor" href="#택배-트럭과-물류-시스템-비유"><span>택배 트럭과 물류 시스템 비유</span></a></h2><blockquote><p>&quot;CAN은 택배 트럭이고, J1939은 물류 시스템이다.&quot;</p></blockquote><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">CAN (택배 트럭)</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>CAN 위에 상위 프로토콜을 올려야 비로소 실용적인 차량 네트워크가 완성된다.</p><h1 id="_2-상위-프로토콜-지도" tabindex="-1"><a class="header-anchor" href="#_2-상위-프로토콜-지도"><span>2. 상위 프로토콜 지도</span></a></h1><h2 id="osi-7계층에서의-위치" tabindex="-1"><a class="header-anchor" href="#osi-7계층에서의-위치"><span>OSI 7계층에서의 위치</span></a></h2><p>CAN 기반 상위 프로토콜은 모두 OSI 모델의 3계층 이상을 담당한다.</p><pre class="mermaid">block-beta
  columns 3
  ...
  block:proto[&quot;프로토콜 스택&quot;]:2
    ...
    CAN --&gt; J1939
    J1939 --&gt; ISOBUS
</pre><blockquote><p>ISOBUS는 J1939을 기반으로 농기계 도메인에 특화한 확장 프로토콜이다. J1939을 이해하면 ISOBUS의 절반은 이해한 것이다.</p></blockquote><h1 id="_3-j1939이란" tabindex="-1"><a class="header-anchor" href="#_3-j1939이란"><span>3. J1939이란</span></a></h1><p>SAE(Society of Automotive Engineers)가 정의한 <strong>대형 차량 및 작업 기계용 통신 상위 프로토콜</strong>이다.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">표준명: SAE J1939</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>J1939이 정의하는 것들:</p><ul><li><strong>PGN (Parameter Group Number)</strong>: 메시지 종류 식별자</li><li><strong>SPN (Suspect Parameter Number)</strong>: 데이터 필드 내 개별 파라미터 식별자</li><li><strong>소스/목적지 주소 관리</strong></li><li><strong>Transport Protocol</strong>: 8바이트 초과 데이터를 여러 프레임으로 분할 전송</li><li><strong>네트워크 관리</strong>: 주소 요청, 주소 충돌 감지</li></ul><h1 id="_4-j1939과-can의-관계" tabindex="-1"><a class="header-anchor" href="#_4-j1939과-can의-관계"><span>4. J1939과 CAN의 관계</span></a></h1><h2 id="_29비트-can-id의-구조화" tabindex="-1"><a class="header-anchor" href="#_29비트-can-id의-구조화"><span>29비트 CAN ID의 구조화</span></a></h2><p>Classic CAN 2.0B는 29비트 확장 ID를 제공하지만, 이 ID를 어떻게 쓸지는 규정하지 않는다. J1939은 이 29비트를 다음과 같이 <strong>명확한 필드로 구조화</strong>한다.</p><p><img src="`+c+'" alt="J1939 29비트 CAN ID 필드 구조: Priority(0-2), EDP(3), DP(4), PF(5-12), PS(13-20), SA(21-28)"><img src="'+g+'" alt="J1939 29비트 CAN ID 필드 구조: Priority(0-2), EDP(3), DP(4), PF(5-12), PS(13-20), SA(21-28)"></p><table><thead><tr><th>필드</th><th>비트 수</th><th>설명</th></tr></thead><tbody><tr><td><strong>Priority</strong></td><td>3</td><td>메시지 우선순위. 0이 최고, 7이 최저</td></tr><tr><td><strong>EDP</strong></td><td>1</td><td>Extended Data Page. J1939에서는 보통 0</td></tr><tr><td><strong>DP</strong></td><td>1</td><td>Data Page. PGN 공간을 두 배로 확장</td></tr><tr><td><strong>PF</strong></td><td>8</td><td>PDU Format. 메시지 유형 결정 (PDU1 vs PDU2 구분)</td></tr><tr><td><strong>PS</strong></td><td>8</td><td>PDU Specific. PF &lt; 240이면 목적지 주소, PF &gt;= 240이면 그룹 확장</td></tr><tr><td><strong>SA</strong></td><td>8</td><td>Source Address. 메시지를 보내는 노드의 주소 (0x00~0xFD)</td></tr></tbody></table><h2 id="_29비트-id-예시-해석" tabindex="-1"><a class="header-anchor" href="#_29비트-id-예시-해석"><span>29비트 ID 예시 해석</span></a></h2><p>hex → binary: 0x18FEE000 = 0001 1000 1111 1110 1110 0000 0000 0000 (32bit), 하위 29비트만 취해 필드로 분해하면 다음과 같다.</p><p><img src="'+A+'" alt="0x18FEE000 CAN ID 분해: Priority=6, EDP=0, DP=0, PF=0xFE(254), PS=0xE0(224), SA=0x00"><img src="'+b+`" alt="0x18FEE000 CAN ID 분해: Priority=6, EDP=0, DP=0, PF=0xFE(254), PS=0xE0(224), SA=0x00"></p><p>29비트 ID의 구조를 이해했으니, 이제 이 ID 체계 위에서 실제 J1939 네트워크가 어떻게 구성되는지 살펴보자.</p><h1 id="_5-j1939-네트워크-구성" tabindex="-1"><a class="header-anchor" href="#_5-j1939-네트워크-구성"><span>5. J1939 네트워크 구성</span></a></h1><h2 id="소스-어드레스-sa-할당" tabindex="-1"><a class="header-anchor" href="#소스-어드레스-sa-할당"><span>소스 어드레스(SA) 할당</span></a></h2><p>J1939은 노드마다 <strong>고유한 소스 어드레스(SA)</strong>를 부여한다. SAE J1939-81(네트워크 관리) 규격이 주소 요청/충돌 감지 절차를 정의한다.</p><p>예약된 주소 예시:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">SA 0x00 (0)   : Engine #1</span>
