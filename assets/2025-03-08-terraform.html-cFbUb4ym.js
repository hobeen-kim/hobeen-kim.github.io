import{_ as i,c as t,b as r,a as n,d,r as e,o as c}from"./app-DkdXoDKs.js";const p="/images/2025-03-08-terraform/image-20250309222039484.png",u="/images/2025-03-08-terraform/image-20250310233826614.png",o={};function v(m,s){const a=e("description"),l=e("Footer");return c(),t("div",null,[s[0]||(s[0]=r("p",null,"처음 AWS 를 배울 때 클라우드는 나에게 미지의 영역이었고 깊은 안개 속에 있었다. 그런 점에서 테라폼을 처음 접했을 때는 놀라웠다. 잘 작성된 tf 파일 하나면 aws 콘솔에 접근할 필요없이 몇 분이면 서버와 애플리케이션을 배포할 수 있다. 테라폼을 깊게 배워서 업무에 적용하고 싶다는 생각이 강하게 들었고 지금도 조금씩 배우며 적용하고 있다.",-1)),n(a),s[1]||(s[1]=d(`<blockquote><p>[!NOTE]<br> 책 전체가 아닌 필요한(모르는) 부분만 정리함</p></blockquote><h1 id="iac-와-테라폼" tabindex="-1"><a class="header-anchor" href="#iac-와-테라폼"><span>IaC 와 테라폼</span></a></h1><p>IaC 도입의 긍정적인 측면은 다음과 같다.</p><ul><li>속도와 효율성</li><li>버전 관리</li><li>협업</li><li>재사용성</li><li>기술의 자산화</li></ul><h1 id="기본-사용법" tabindex="-1"><a class="header-anchor" href="#기본-사용법"><span>기본 사용법</span></a></h1><div class="language-terraform line-numbers-mode" data-highlighter="prismjs" data-ext="terraform" data-title="terraform"><pre><code><span class="line">resource &quot;local_file&quot; &quot;abc&quot; {</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="state" tabindex="-1"><a class="header-anchor" href="#state"><span>State</span></a></h1><h2 id="워크스페이스" tabindex="-1"><a class="header-anchor" href="#워크스페이스"><span>워크스페이스</span></a></h2><p>state 를 관리하는 논리적인 가상 공간이다. 테라폼 구성 파일은 동일하지만 작업자는 서로 다른 state 를 갖는 실제 대상을 프로비저닝할 수 있다.</p><p><img src="`+p+`" alt="image-20250309222039484"></p><p>terraform workspace list 로 워크스페이스의 목록을 볼 수 있다.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">$ terraform workspace list</span>
<span class="line">* default</span>
