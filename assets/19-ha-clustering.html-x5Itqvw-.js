...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>v26의 &quot;Persistent user sessions&quot; 기능과 맞물리면 Keycloak 재기동 시에도 세션이 살아남는다. 이제 세션이 Infinispan 클러스터에 모여 있으므로, Keycloak Pod 하나가 죽어도 사용자는 재로그인할 필요가 없다.</p><h2 id="_5-캐시-동기화-모드" tabindex="-1"><a class="header-anchor" href="#_5-캐시-동기화-모드"><span>5. 캐시 동기화 모드</span></a></h2><p>Infinispan 캐시의 쓰기 전파 방식은 <strong>SYNC</strong>와 <strong>ASYNC</strong> 두 가지다. 선택에 따라 처리량과 정합성이 크게 달라진다.</p><h3 id="sync-모드" tabindex="-1"><a class="header-anchor" href="#sync-모드"><span>SYNC 모드</span></a></h3><pre class="mermaid">sequenceDiagram
