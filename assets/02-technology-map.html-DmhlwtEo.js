import{_ as d,c as r,e as n,o as l}from"./app-BTUxan41.js";const e={};function a(i,t){return l(),r("div",null,t[0]||(t[0]=[n(`<div class="hint-container info"><p class="hint-container-title">학습 목표</p><ul><li>스마트농업 기술 스택을 4개 계층(하드웨어·통신·플랫폼·지능)으로 설명할 수 있다.</li><li>노지농업과 시설농업의 기술적 차이를 비교할 수 있다.</li><li>센서에서 농기계 자동제어까지 이어지는 데이터 파이프라인을 도식으로 그릴 수 있다.</li><li>주요국의 스마트농업 현황을 서술할 수 있다.</li></ul></div><h2 id="기술-스택-조감도" tabindex="-1"><a class="header-anchor" href="#기술-스택-조감도"><span>기술 스택 조감도</span></a></h2><p>스마트농업을 구성하는 기술은 4개 계층으로 정리할 수 있다. 아래 계층일수록 물리 세계와 맞닿아 있고, 위로 올라갈수록 추상화 수준이 높아진다.</p><pre class="mermaid">mindmap
  root((스마트농업&lt;br&gt;기술 스택))
    하드웨어 계층
      센서
        토양 센서
