"""CH8 §4 예시 0x18FEE000 → 필드 분해 (light/dark PNG)."""
...
FIELDS = [
    ...
    ("PS", "1110 0000", "0xE0=224\nGroup Extension", 8, "gray"),
    ("SA", "0000 0000", "0x00\n엔진 ECU", 8, "orange"),
]
...
def draw(d):
    ...
    d.text(x0, y + h + 6.4, "0x18FEE000", size=11, weight="bold", ha="left", color=P["accent"])
...
diagram("08-canid-example", draw, w=13, h=4.6, xmax=94, ymax=24)
