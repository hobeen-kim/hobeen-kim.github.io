...
</pre><h3 id="_3-3-우선순위-기반-중재-csma-cd-amp" tabindex="-1"><a class="header-anchor" href="#_3-3-우선순위-기반-중재-csma-cd-amp"><span>3.3 우선순위 기반 중재 (CSMA/CD+AMP)</span></a></h3><p>CAN은 <strong>CSMA/CD+AMP</strong> 방식을 사용한다.</p><ul><li><strong>CSMA (Carrier Sense Multiple Access)</strong>: 버스가 비어 있을 때만 전송 시작</li><li><strong>CD (Collision Detection)</strong>: 충돌 감지</li><li><strong>AMP (Arbitration on Message Priority)</strong>: 메시지 우선순위로 중재</li></ul><p>두 노드가 동시에 전송을 시작하면, <strong>ID 값이 낮을수록 우선순위가 높다</strong>. ID를 비트 단위로 비교해 나가면서 먼저 Recessive(1)를 보낸 노드가 자동으로 물러납니다.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">노드A가 보내는 ID: 0 1 0 0 ...</span>
