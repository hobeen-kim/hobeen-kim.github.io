...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h1 id="_5-j1939-네트워크-구성" tabindex="-1"><a class="header-anchor" href="#_5-j1939-네트워크-구성"><span>5. J1939 네트워크 구성</span></a></h1><h2 id="소스-어드레스-sa-할당" tabindex="-1"><a class="header-anchor" href="#소스-어드레스-sa-할당"><span>소스 어드레스(SA) 할당</span></a></h2><p>J1939은 노드마다 <strong>고유한 소스 어드레스(SA)</strong>를 부여한다. SAE J1939-81(네트워크 관리) 규격이 주소 요청/충돌 감지 절차를 정의한다.</p><p>예약된 주소 예시:</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">SA 0x00 (0)   : Engine #1</span>
