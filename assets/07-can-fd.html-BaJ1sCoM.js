import{_ as r,c as p,a,b as n,d as o,f as e,r as i,o as c,e as l}from"./app-C19JOZcM.js";const u={},h={class:"table-of-contents"};function b(C,s){const d=i("Header"),t=i("router-link");return c(),p("div",null,[a(d),n("nav",h,[n("ul",null,[n("li",null,[a(t,{to:"#학습-목표"},{default:e(()=>s[0]||(s[0]=[l("학습 목표")])),_:1})]),n("li",null,[a(t,{to:"#_1-can-fd가-나온-이유"},{default:e(()=>s[1]||(s[1]=[l("1. CAN FD가 나온 이유")])),_:1}),n("ul",null,[n("li",null,[a(t,{to:"#기존-can의-한계"},{default:e(()=>s[2]||(s[2]=[l("기존 CAN의 한계")])),_:1})])])]),n("li",null,[a(t,{to:"#_2-can-fd의-구조"},{default:e(()=>s[3]||(s[3]=[l("2. CAN FD의 구조")])),_:1}),n("ul",null,[n("li",null,[a(t,{to:"#새로-추가된-제어-비트"},{default:e(()=>s[4]||(s[4]=[l("새로 추가된 제어 비트")])),_:1})]),n("li",null,[a(t,{to:"#can-fd-프레임-구조"},{default:e(()=>s[5]||(s[5]=[l("CAN FD 프레임 구조")])),_:1})]),n("li",null,[a(t,{to:"#프레임-흐름-다이어그램"},{default:e(()=>s[6]||(s[6]=[l("프레임 흐름 다이어그램")])),_:1})]),n("li",null,[a(t,{to:"#최대-64바이트-페이로드"},{default:e(()=>s[7]||(s[7]=[l("최대 64바이트 페이로드")])),_:1})])])]),n("li",null,[a(t,{to:"#_3-듀얼-비트레이트"},{default:e(()=>s[8]||(s[8]=[l("3. 듀얼 비트레이트")])),_:1}),n("ul",null,[n("li",null,[a(t,{to:"#두-개의-phase"},{default:e(()=>s[9]||(s[9]=[l("두 개의 Phase")])),_:1})]),n("li",null,[a(t,{to:"#brs-비트가-전환-신호"},{default:e(()=>s[10]||(s[10]=[l("BRS 비트가 전환 신호")])),_:1})]),n("li",null,[a(t,{to:"#실제-처리량-비교-예시"},{default:e(()=>s[11]||(s[11]=[l("실제 처리량 비교 예시")])),_:1})])])]),n("li",null,[a(t,{to:"#_4-can-2-0과의-호환성"},{default:e(()=>s[12]||(s[12]=[l("4. CAN 2.0과의 호환성")])),_:1}),n("ul",null,[n("li",null,[a(t,{to:"#같은-버스에서-공존할-수-있는가"},{default:e(()=>s[13]||(s[13]=[l("같은 버스에서 공존할 수 있는가?")])),_:1})]),n("li",null,[a(t,{to:"#isobus와-can-fd"},{default:e(()=>s[14]||(s[14]=[l("ISOBUS와 CAN FD")])),_:1})]),n("li",null,[a(t,{to:"#다음-챕터"},{default:e(()=>s[15]||(s[15]=[l("다음 챕터")])),_:1})])])])])]),s[16]||(s[16]=o(`<h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>CAN FD가 등장한 배경과 Classic CAN의 한계를 설명할 수 있다.</li><li>FDF, BRS, ESI 비트의 역할을 이해하고 CAN FD 프레임 구조를 설명할 수 있다.</li><li>듀얼 비트레이트 동작 원리와 BRS 비트의 역할을 이해한다.</li><li>FD tolerant / FD active 노드의 차이를 구분하고, ISOBUS와의 관계를 설명할 수 있다.</li></ul><hr><h1 id="_1-can-fd가-나온-이유" tabindex="-1"><a class="header-anchor" href="#_1-can-fd가-나온-이유"><span>1. CAN FD가 나온 이유</span></a></h1><h2 id="기존-can의-한계" tabindex="-1"><a class="header-anchor" href="#기존-can의-한계"><span>기존 CAN의 한계</span></a></h2><p>1986년 Bosch가 발표한 Classic CAN은 자동차 네트워크의 표준으로 자리 잡았다. 그러나 자동차 전자화가 가속화되면서 두 가지 근본적인 한계에 부딪혔다.</p><table><thead><tr><th>항목</th><th>Classic CAN (2.0B)</th><th>요구 사항</th></tr></thead><tbody><tr><td>최대 페이로드</td><td>8 바이트</td><td>수십~수백 바이트</td></tr><tr><td>최대 비트레이트</td><td>1 Mbps</td><td>수 Mbps 이상</td></tr></tbody></table><p><strong>한계 1 — 8바이트 페이로드 상한</strong></p><p>ECU 소프트웨어 업데이트(OTA), 레이더/카메라 데이터, 고정밀 센서 융합 등 현대 자동차 기능은 한 프레임에 훨씬 많은 데이터를 담아야 한다. 8바이트로는 여러 프레임으로 쪼개서 보내야 하고, 이는 오버헤드와 응답 지연을 유발한다.</p><p><strong>한계 2 — 1 Mbps 비트레이트 상한</strong></p><p>버스 길이와 전파 지연 특성상 Classic CAN은 이론적으로 1 Mbps가 최대다. ADAS, 자율주행처럼 실시간성이 요구되는 애플리케이션에서는 이 속도로는 대역폭이 부족하다.</p><p>Bosch는 이 두 한계를 모두 해결하기 위해 <strong>2012년 CAN FD(CAN with Flexible Data-rate)</strong> 규격을 발표했다.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Classic CAN 한계 요약</span>
