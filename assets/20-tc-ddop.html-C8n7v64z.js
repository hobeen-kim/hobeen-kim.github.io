import{_ as e,c as d,d as n,o as D}from"./app-BsKQU4X_.js";const o={};function r(l,t){return D(),d("div",null,t[0]||(t[0]=[n(`<h1 id="tc-디바이스-디스크립션-ddop" tabindex="-1"><a class="header-anchor" href="#tc-디바이스-디스크립션-ddop"><span>TC 디바이스 디스크립션 (DDOP)</span></a></h1><h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>DDOP가 무엇이고 왜 필요한지 설명할 수 있다.</li><li>DDOP를 구성하는 5가지 오브젝트 타입의 역할을 구분할 수 있다.</li><li>DDOP 전송 과정을 시퀀스 다이어그램으로 그릴 수 있다.</li><li>3구획 살포기의 DDOP를 직접 설계하고 오브젝트 표를 작성할 수 있다.</li></ul><hr><h2 id="_1-ddop란" tabindex="-1"><a class="header-anchor" href="#_1-ddop란"><span>1. DDOP란</span></a></h2><p><strong>DDOP(Device Description Object Pool)</strong>는 작업기가 자기 자신의 구조와 능력을 TC에게 알려주는 데이터 집합이다.</p><blockquote><p>DDOP는 &quot;작업기의 자기소개서&quot;이다.</p></blockquote><p>TC-Server는 버스에 연결된 작업기에 대해 아무런 사전 정보가 없다. 작업기가 어떤 구획(Section)을 가졌는지, 어떤 DDI를 지원하는지, 작업폭이 얼마인지를 TC는 알 수 없다. DDOP는 이 정보를 구조화된 형식으로 TC에 전달하여, TC가 작업기를 이해하고 제어할 수 있게 한다.</p><p><strong>DDOP가 없다면:</strong></p><ul><li>TC는 작업기에 어떤 명령을 보낼 수 있는지 모릅니다.</li><li>처방 맵의 살포량을 어느 DDI로 전달해야 하는지 알 수 없다.</li><li>Section Control을 위해 몇 개의 구획이 있는지 파악하지 못한다.</li></ul><p><strong>DDOP가 있다면:</strong></p><ul><li>TC는 작업기의 구조를 파악하고 적절한 명령을 선택한다.</li><li>지원되지 않는 DDI로의 명령 시도를 사전에 방지한다.</li></ul><hr><h2 id="_2-ddop-오브젝트-구조" tabindex="-1"><a class="header-anchor" href="#_2-ddop-오브젝트-구조"><span>2. DDOP 오브젝트 구조</span></a></h2><p>DDOP는 5가지 타입의 오브젝트로 구성된다.</p><table><thead><tr><th>오브젝트 타입</th><th>역할</th><th>주요 속성</th></tr></thead><tbody><tr><td><strong>Device</strong></td><td>장치 전체 정보 (최상위)</td><td>제조사, 제품명, 시리얼번호, Structure Label</td></tr><tr><td><strong>DeviceElement</strong></td><td>장치의 논리적 구성 요소</td><td>Element Type, Element Number, 부모 Element</td></tr><tr><td><strong>DeviceProcessData</strong></td><td>지원하는 프로세스 데이터 항목</td><td>DDI, Property Flag (Setpoint/Measurement), Trigger Methods</td></tr><tr><td><strong>DeviceProperty</strong></td><td>고정 속성값</td><td>DDI, 값 (작업폭, 구획 폭 등)</td></tr><tr><td><strong>DeviceValuePresentation</strong></td><td>데이터 표현 방식</td><td>오프셋, 스케일, 단위 기호</td></tr></tbody></table><pre class="mermaid">graph TD
    DVC[&quot;Device\\n살포기 전체\\n제조사/모델/S/N&quot;]
