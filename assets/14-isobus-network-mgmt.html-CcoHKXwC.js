import{_ as n,c as e,d as r,o as s}from"./app-B9xfQh4I.js";const d={};function i(a,t){return s(),e("div",null,t[0]||(t[0]=[r(`<h1 id="isobus-네트워크-관리" tabindex="-1"><a class="header-anchor" href="#isobus-네트워크-관리"><span>ISOBUS 네트워크 관리</span></a></h1><h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>ISOBUS의 주소 클레임 방식과 CF(Control Function) 개념을 설명할 수 있다.</li><li>Working Set Master와 Member의 관계를 도식으로 이해한다.</li><li>DM1~DM3 진단 메시지의 역할과 SPN+FMI 조합을 구분할 수 있다.</li><li>전원 ON부터 통신 완료까지의 시간 흐름을 설명할 수 있다.</li></ul><hr><h2 id="_1-주소-클레임-isobus-방식" tabindex="-1"><a class="header-anchor" href="#_1-주소-클레임-isobus-방식"><span>1. 주소 클레임 (ISOBUS 방식)</span></a></h2><p>ISOBUS의 주소 클레임은 J1939의 방식을 기반으로 하되, 농업 기계에 맞게 확장된 규칙을 적용합니다.</p><h3 id="cf-control-function" tabindex="-1"><a class="header-anchor" href="#cf-control-function"><span>CF (Control Function)</span></a></h3><p>ISOBUS에서는 네트워크에 참여하는 모든 장치를 <strong>CF(Control Function)</strong>라고 부릅니다. 하나의 물리적 ECU가 여러 CF를 포함할 수도 있습니다. 각 CF는 독립적인 주소를 가집니다.</p><h3 id="주소-범위" tabindex="-1"><a class="header-anchor" href="#주소-범위"><span>주소 범위</span></a></h3><table><thead><tr><th>주소 범위</th><th>용도</th></tr></thead><tbody><tr><td>0 ~ 127</td><td>고정 주소 (특정 기능에 예약)</td></tr><tr><td>128 ~ 247</td><td><strong>Self-Configurable 주소</strong> (동적 협상)</td></tr><tr><td>248 ~ 253</td><td>산업별 예약</td></tr><tr><td>254</td><td>Null Address (주소 미확정 상태)</td></tr><tr><td>255</td><td>Global Address (브로드캐스트)</td></tr></tbody></table><p>ISOBUS 작업기 ECU는 대부분 <strong>128~247</strong> 범위의 Self-Configurable 주소를 사용합니다. 이 범위의 주소는 여러 장치가 동시에 원할 경우 NAME 값의 우선순위로 자동 협상됩니다.</p><h3 id="주소-클레임-흐름" tabindex="-1"><a class="header-anchor" href="#주소-클레임-흐름"><span>주소 클레임 흐름</span></a></h3><pre class="mermaid">sequenceDiagram
    ...
    TC[&quot;TC\\n(작업 컨트롤러)&quot;] -- &quot;섹션 명령&quot; --&gt; WSM
</pre><h3 id="working-set-선언-메시지-pgn-65070" tabindex="-1"><a class="header-anchor" href="#working-set-선언-메시지-pgn-65070"><span>Working Set 선언 메시지 (PGN 65070)</span></a></h3><p>WSM은 네트워크에 참여한 후 <strong>PGN 65070 (Working Set Master)</strong>를 브로드캐스트하여 자신이 마스터임을 선언합니다. 이 메시지에는 Working Set에 속한 멤버 수가 포함됩니다.</p><p>멤버 ECU들은 <strong>PGN 65075 (Working Set Member)</strong>를 전송하여 자신이 특정 마스터에 속함을 알립니다.</p><p>VT와 TC는 이 메시지를 수신하여 작업기의 구조를 파악하고, WSM을 통해서만 작업기와 통신합니다.</p><hr><h2 id="_3-진단-메시지" tabindex="-1"><a class="header-anchor" href="#_3-진단-메시지"><span>3. 진단 메시지</span></a></h2><p>ISOBUS는 ISO 11783-12를 통해 표준화된 진단 메시지를 정의합니다. J1939의 진단 메시지 체계를 그대로 사용합니다.</p><h3 id="고장-코드-구조-spn-fmi" tabindex="-1"><a class="header-anchor" href="#고장-코드-구조-spn-fmi"><span>고장 코드 구조: SPN + FMI</span></a></h3><p>모든 고장은 <strong>SPN(Suspect Parameter Number)</strong>과 <strong>FMI(Failure Mode Identifier)</strong>의 조합으로 식별합니다.</p><ul><li><strong>SPN</strong>: 어떤 파라미터에 문제가 생겼는지 (예: SPN 100 = 엔진 오일 압력)</li><li><strong>FMI</strong>: 어떤 종류의 고장인지 (예: FMI 1 = 데이터 낮음, FMI 3 = 전압 높음)</li></ul><h3 id="주요-진단-메시지" tabindex="-1"><a class="header-anchor" href="#주요-진단-메시지"><span>주요 진단 메시지</span></a></h3><table><thead><tr><th>메시지</th><th>PGN</th><th>이름</th><th>설명</th></tr></thead><tbody><tr><td>DM1</td><td>65226</td><td>Active Diagnostic Troubles</td><td>현재 발생 중인 활성 고장 코드 목록</td></tr><tr><td>DM2</td><td>65227</td><td>Previously Active Diagnostics</td><td>이전에 발생했다가 해소된 고장 코드</td></tr><tr><td>DM3</td><td>65228</td><td>Diagnostic Data Clear</td><td>저장된 고장 코드 초기화 요청</td></tr></tbody></table><pre class="mermaid">graph LR
    subgraph 진단_메시지_흐름
