...
<span class="line">│   ├── goal.md               ← 북극성 문서 (현재 목표)</span>
<span class="line">│   ├── plans/                ← 실행 전 합의 문서</span>
<span class="line">│   ├── implementations/      ← 실행 결과 + 증거</span>
<span class="line">│   ├── decisions/            ← ADR (왜 이 결정?)</span>
<span class="line">│   ├── wisdom/               ← 패턴 누적 + 실수 방지</span>
<span class="line">│   ├── skills/               ← 자기 강화 skill 파일</span>
...
<span class="line"><span class="token list punctuation">-</span> implementations에 goal_ref와 instruction은 필수다.</span>
...
<span class="line">  <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h2 id="_4-구현-후-문서-업데이트-플로우" tabindex="-1"><a class="header-anchor" href="#_4-구현-후-문서-업데이트-플로우"><span>4. 구현 후 문서 업데이트 플로우</span></a></h2><p>구현이 완료된 시점에 에이전트가 반드시 작성해야 하는 문서가 있다. 이 플로우를 지키지 않으면 &quot;왜 이렇게 구현했는가&quot;, &quot;어떤 지시에 의해 시작했는가&quot;를 나중에 추적할 수 없다.</p><pre class="mermaid">flowchart TD
    ...
    GOAL --&gt;|미충족| MORE[추가 구현]
</pre><h3 id="implementations-필수-필드" tabindex="-1"><a class="header-anchor" href="#implementations-필수-필드"><span>implementations/ 필수 필드</span></a></h3><p>구현이 완료되면 <code>.claude/implementations/{작업명}.md</code>를 작성한다. 다음 필드가 모두 있어야 Verifier가 검증할 수 있다.</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre><code><span class="line"><span class="token punctuation">---</span></span>
...
<span class="line"><span class="token key atrule">goal_ref</span><span class="token punctuation">:</span> <span class="token string">&quot;.claude/goal.md&quot;</span>          <span class="token comment"># 이 구현을 트리거한 goal</span></span>
<span class="line"><span class="token key atrule">plan_ref</span><span class="token punctuation">:</span> <span class="token string">&quot;.claude/plans/작업명.md&quot;</span>  <span class="token comment"># 기반이 된 plan</span></span>
<span class="line"><span class="token key atrule">instruction</span><span class="token punctuation">:</span> <span class="token string">&quot;사용자가 인증 모듈 OAuth 전환을 지시&quot;</span> <span class="token comment"># 어떤 지시에 의해 시작했는가</span></span>
<span class="line"><span class="token key atrule">status</span><span class="token punctuation">:</span> pending_review</span>
<span class="line"><span class="token key atrule">evidence</span><span class="token punctuation">:</span></span>
<span class="line">  <span class="token punctuation">-</span> <span class="token key atrule">path</span><span class="token punctuation">:</span> <span class="token string">&quot;src/auth/oauth.ts&quot;</span></span>
...
<span class="line">  <span class="token punctuation">-</span> <span class="token key atrule">path</span><span class="token punctuation">:</span> <span class="token string">&quot;tests/auth.test.ts&quot;</span></span>
<span class="line">    <span class="token key atrule">commit</span><span class="token punctuation">:</span> <span class="token string">&quot;abc1234&quot;</span></span>
...
<span class="line"><span class="token punctuation">---</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 구현 내용</span></span>
<span class="line"></span>
<span class="line"><span class="token comment">## 달성한 것</span></span>
<span class="line"><span class="token punctuation">-</span> OAuth 2.0 엔드포인트 구현 완료</span>
<span class="line"></span>
<span class="line"><span class="token comment">## 증거</span></span>
<span class="line">위 frontmatter의 evidence 참조</span>
<span class="line"></span>
<span class="line"><span class="token comment">## goal과의 연결</span></span>
<span class="line">\`.claude/goal.md\`의 objective &quot;레거시 인증 코드를 OAuth 2.0 기반으로 전환한다&quot;를 달성하기 위해 실행했다.</span>
<span class="line">success_criteria 중 &quot;신규 OAuth 엔드포인트 정상 동작 확인&quot;을 충족한다.</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>goal_ref</code>와 <code>instruction</code>이 핵심이다. goal_ref는 이 구현이 어떤 목표를 달성하기 위한 것인지 연결한다. instruction은 &quot;어떤 지시에 의해 이 작업이 시작됐는가&quot;를 한 줄로 기록한다.</p><h3 id="추적-체인" tabindex="-1"><a class="header-anchor" href="#추적-체인"><span>추적 체인</span></a></h3><p>이 세 필드가 모이면 구현 출처를 완전히 역추적할 수 있다.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">instruction (어떤 지시?) </span>
<span class="line">    → goal_ref → goal.md (무엇을 달성?)</span>
<span class="line">    → plan_ref → plans/ (어떻게 실행?)</span>
<span class="line">    → implementations/ (무엇을 했는가?)</span>
<span class="line">    → decisions/ (왜 그 방식?)</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-동작-확인" tabindex="-1"><a class="header-anchor" href="#_5-동작-확인"><span>5. 동작 확인</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 레지스트리 초기화 확인</span></span>
