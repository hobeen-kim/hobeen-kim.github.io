      ...
      '/study/keycloak/': [
        {
          ...
          children: [
            ...
            { text: 'CH2. 핵심 개념과 용어', link: '/study/keycloak/02-core-concepts' },
          ],
        },
        {
          text: '핵심 객체 모델',
          collapsible: false,
          children: [
            { text: 'CH3. Realm과 Organizations', link: '/study/keycloak/03-realm-organizations' },
            { text: 'CH4. Client와 Service Account', link: '/study/keycloak/04-client-service-account' },
            { text: 'CH5. 사용자와 자격 증명', link: '/study/keycloak/05-user-credentials' },
            { text: 'CH6. Role·Group과 Composite Role', link: '/study/keycloak/06-role-group' },
          ],
        },
        {
          text: '토큰·권한·프로토콜',
          collapsible: false,
          children: [
            { text: 'CH7. Client Scope와 Protocol Mapper', link: '/study/keycloak/07-protocol-mapper' },
            { text: 'CH8. Authorization Services와 UMA', link: '/study/keycloak/08-authz-uma' },
            { text: 'CH9. SAML 2.0과 Token Exchange', link: '/study/keycloak/09-saml-token-exchange' },
          ],
        },
        {
          text: '인증 정책과 플로우',
          collapsible: false,
          children: [
            { text: 'CH10. 인증 플로우 커스터마이징', link: '/study/keycloak/10-auth-flow' },
            { text: 'CH11. Password Policy와 Brute Force', link: '/study/keycloak/11-password-policy' },
            { text: 'CH12. MFA — TOTP / WebAuthn', link: '/study/keycloak/12-mfa' },
          ],
        },
        {
          text: '페더레이션',
          collapsible: false,
          children: [
            { text: 'CH13. User Federation (LDAP/AD)', link: '/study/keycloak/13-user-federation' },
            { text: 'CH14. Identity Brokering', link: '/study/keycloak/14-identity-brokering' },
          ],
        },
        {
          text: '커스터마이징 (SPI)',
          collapsible: false,
          children: [
            { text: 'CH15. SPI로 Keycloak 확장', link: '/study/keycloak/15-spi-overview' },
            { text: 'CH16. 커스텀 Authenticator', link: '/study/keycloak/16-custom-authenticator' },
            { text: 'CH17. 커스텀 User Storage', link: '/study/keycloak/17-custom-user-storage' },
            { text: 'CH18. Theme 커스터마이징', link: '/study/keycloak/18-theme' },
          ],
        },
        {
          text: '운영과 확장',
          collapsible: false,
          children: [
            { text: 'CH19. Infinispan HA 클러스터링', link: '/study/keycloak/19-ha-clustering' },
            { text: 'CH20. Kubernetes + Operator 배포', link: '/study/keycloak/20-k8s-operator' },
            { text: 'CH21. 데이터베이스와 성능', link: '/study/keycloak/21-database-performance' },
            { text: 'CH22. Admin REST API와 자동화', link: '/study/keycloak/22-admin-rest-api' },
            { text: 'CH23. Backup/Restore와 Realm 이관', link: '/study/keycloak/23-backup-restore' },
            { text: 'CH24. 모니터링·감사와 업그레이드', link: '/study/keycloak/24-monitoring-upgrade' },
          ],
        },
      ],
      '/study/oauth/': [
