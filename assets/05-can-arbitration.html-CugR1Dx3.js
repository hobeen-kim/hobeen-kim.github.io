import{_ as o,c as d,a as i,b as n,d as p,f as e,r,o as u,e as a}from"./app-BsKQU4X_.js";const g={},c={class:"table-of-contents"};function h(b,t){const l=r("Header"),s=r("router-link");return u(),d("div",null,[i(l),n("nav",c,[n("ul",null,[n("li",null,[i(s,{to:"#can-중재와-우선순위"},{default:e(()=>t[0]||(t[0]=[a("CAN 중재와 우선순위")])),_:1}),n("ul",null,[n("li",null,[i(s,{to:"#학습-목표"},{default:e(()=>t[1]||(t[1]=[a("학습 목표")])),_:1})]),n("li",null,[i(s,{to:"#_1-버스-중재-arbitration-란"},{default:e(()=>t[2]||(t[2]=[a("1. 버스 중재(Arbitration)란")])),_:1})]),n("li",null,[i(s,{to:"#_2-비트-단위-중재-과정"},{default:e(()=>t[3]||(t[3]=[a("2. 비트 단위 중재 과정")])),_:1})]),n("li",null,[i(s,{to:"#_3-id-값과-우선순위-관계"},{default:e(()=>t[4]||(t[4]=[a("3. ID 값과 우선순위 관계")])),_:1})]),n("li",null,[i(s,{to:"#_4-메시지-설계-시-고려사항"},{default:e(()=>t[5]||(t[5]=[a("4. 메시지 설계 시 고려사항")])),_:1})]),n("li",null,[i(s,{to:"#다음-챕터"},{default:e(()=>t[6]||(t[6]=[a("다음 챕터")])),_:1})])])])])]),t[7]||(t[7]=p(`<h1 id="can-중재와-우선순위" tabindex="-1"><a class="header-anchor" href="#can-중재와-우선순위"><span>CAN 중재와 우선순위</span></a></h1><h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>CAN 버스의 중재(Arbitration) 개념과 필요성을 설명할 수 있다</li><li>CSMA/CD+AMP 메커니즘의 동작 방식을 이해한다</li><li>비트 단위 중재 과정을 단계별로 추적할 수 있다</li><li>ID 값과 우선순위의 관계를 설명할 수 있다</li><li>안전 관련 메시지 설계 시 ID 배정 원칙을 적용할 수 있다</li></ul><hr><h2 id="_1-버스-중재-arbitration-란" tabindex="-1"><a class="header-anchor" href="#_1-버스-중재-arbitration-란"><span>1. 버스 중재(Arbitration)란</span></a></h2><p><strong>문제 상황<strong>: 여러 노드가 하나의 버스를 공유하는 CAN에서, 두 노드가 </strong>동시에 메시지를 전송하기 시작하면</strong> 어떻게 될까?</p><p>이더넷의 경우 충돌(Collision)이 발생하면 두 노드 모두 전송을 멈추고 임의의 시간 뒤 재전송한다. 이 방식은 충돌 후 데이터가 손실된다.</p><p><strong>CAN의 해답</strong>: CAN은 <strong>CSMA/CD+AMP</strong> 방식을 사용해 충돌 없이 우선순위가 높은 메시지가 이기도록 한다.</p><table><thead><tr><th>용어</th><th>의미</th></tr></thead><tbody><tr><td><strong>CSMA</strong> (Carrier Sense Multiple Access)</td><td>전송 전 버스가 사용 중인지 확인한다</td></tr><tr><td><strong>CD</strong> (Collision Detection)</td><td>전송 중 충돌(다른 신호)을 감지한다</td></tr><tr><td><strong>AMP</strong> (Arbitration on Message Priority)</td><td>메시지 우선순위에 따라 중재한다</td></tr></tbody></table><p><strong>핵심 차이<strong>: 이더넷은 충돌 후 </strong>모두 재전송<strong>하지만, CAN은 중재 패배 노드만 재전송한다. 승리한 노드는 전송을 </strong>중단 없이 계속</strong>한다.</p><blockquote><p>[!INFO] 중재는 ID 필드 전송 구간에서만 일어난다. 중재에서 이긴 노드의 메시지는 데이터 손실 없이 그대로 버스에 전달된다.</p></blockquote><hr><h2 id="_2-비트-단위-중재-과정" tabindex="-1"><a class="header-anchor" href="#_2-비트-단위-중재-과정"><span>2. 비트 단위 중재 과정</span></a></h2><p>중재는 <strong>비트 하나씩</strong> 비교하며 진행된다. 노드A(ID=0x100)와 노드B(ID=0x200)가 동시에 전송을 시작하는 상황을 살펴보자.</p><p><strong>ID 이진수 변환</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">노드A ID = 0x100 = 0001 0000 0000 (11bit)</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Priority 0이 가장 높고, Priority 7이 가장 낮다. 이를 통해 메시지 종류별 우선순위를 명시적으로 설정할 수 있다.</p><p>이 원칙을 이해하면, 실제 시스템에서 메시지 ID를 어떻게 배정해야 하는지가 자연스럽게 도출된다.</p><hr><h2 id="_4-메시지-설계-시-고려사항" tabindex="-1"><a class="header-anchor" href="#_4-메시지-설계-시-고려사항"><span>4. 메시지 설계 시 고려사항</span></a></h2><p>중재 메커니즘을 이해하면 <strong>ID 배정 전략</strong>이 명확해진다.</p><p><strong>안전 관련 메시지에는 낮은 ID를 배정</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">Priority 0 (ID 앞자리 000): 브레이크, 조향, 비상 정지</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>주기적 메시지 vs 이벤트 메시지</strong></p><table><thead><tr><th>구분</th><th>특징</th><th>ID 전략</th></tr></thead><tbody><tr><td><strong>주기적 메시지</strong></td><td>일정 주기(예: 10ms, 100ms)로 반복 전송</td><td>중간 우선순위 배정. 너무 낮은 ID는 다른 중요 메시지를 방해할 수 있음</td></tr><tr><td><strong>이벤트 메시지</strong></td><td>특정 조건 발생 시에만 전송</td><td>안전 관련이면 낮은 ID, 정보성이면 높은 ID</td></tr></tbody></table><p><strong>버스 부하 고려</strong></p><p>중재에서 계속 패배하는 메시지는 버스가 바쁠수록 더 오래 기다려야 한다. 높은 우선순위 메시지가 너무 자주 전송되면, 낮은 우선순위 메시지는 <strong>기아 상태(Starvation)</strong>에 빠질 수 있다.</p><blockquote><p>[!TIP] 실무 설계 원칙:</p><ul><li>안전 관련 메시지: Priority 0~2</li><li>실시간성이 중요한 제어 데이터: Priority 3~4</li><li>진단, 설정, 정보: Priority 5~7</li><li>동일 Priority 내에서는 기능별로 ID 범위를 구분해 관리한다</li></ul></blockquote><div class="hint-container tip"><p class="hint-container-title">핵심 정리</p><ul><li>CAN의 <strong>CSMA/CD+AMP</strong> 방식은 비트 단위로 중재해, 우선순위 높은 메시지가 데이터 손실 없이 전송된다.</li><li>Dominant(0)이 Recessive(1)을 이기므로, <strong>ID 값이 작을수록 우선순위가 높다</strong>.</li><li>중재 패패 노드는 즉시 전송을 중단하고 버스가 빌 때까지 대기 후 재시도한다.</li><li>ISOBUS의 29bit ID에서 상위 3비트(Priority)로 메시지 우선순위를 명시한다.</li><li>안전 관련 메시지(브레이크, 조향)에는 낮은 ID를, 정보성 메시지에는 높은 ID를 배정한다.</li></ul></div><hr><h2 id="다음-챕터" tabindex="-1"><a class="header-anchor" href="#다음-챕터"><span>다음 챕터</span></a></h2><ul><li><strong>이전</strong>: <a href="/study/isobus/04-can-data-frame">04. CAN 데이터 프레임</a></li><li><strong>다음</strong>: <a href="/study/isobus/06-can-error">06. CAN 에러 처리</a></li></ul>`,45))])}const D=o(g,[["render",h],["__file","05-can-arbitration.html.vue"]]),v=JSON.parse('{"path":"/study/isobus/05-can-arbitration.html","title":"CAN 중재와 우선순위","lang":"en-US","frontmatter":{"title":"CAN 중재와 우선순위","description":"두 노드가 동시에 전송할 때 CAN 버스가 충돌 없이 중재하는 메커니즘을 이해한다","date":"2026-04-13T00:00:00.000Z","tags":["isobus","can","arbitration"]},"headers":[{"level":1,"title":"CAN 중재와 우선순위","slug":"can-중재와-우선순위","link":"#can-중재와-우선순위","children":[{"level":2,"title":"학습 목표","slug":"학습-목표","link":"#학습-목표","children":[]},{"level":2,"title":"1. 버스 중재(Arbitration)란","slug":"_1-버스-중재-arbitration-란","link":"#_1-버스-중재-arbitration-란","children":[]},{"level":2,"title":"2. 비트 단위 중재 과정","slug":"_2-비트-단위-중재-과정","link":"#_2-비트-단위-중재-과정","children":[]},{"level":2,"title":"3. ID 값과 우선순위 관계","slug":"_3-id-값과-우선순위-관계","link":"#_3-id-값과-우선순위-관계","children":[]},{"level":2,"title":"4. 메시지 설계 시 고려사항","slug":"_4-메시지-설계-시-고려사항","link":"#_4-메시지-설계-시-고려사항","children":[]},{"level":2,"title":"다음 챕터","slug":"다음-챕터","link":"#다음-챕터","children":[]}]}],"git":{},"filePathRelative":"_study/isobus/05-can-arbitration.md"}');export{D as comp,v as data};
