import{_ as d,c as o,a as i,b as n,d as p,f as e,r as l,o as u,e as a}from"./app-C19JOZcM.js";const c={},g={class:"table-of-contents"};function v(h,t){const r=l("Header"),s=l("router-link");return u(),o("div",null,[i(r),n("nav",g,[n("ul",null,[n("li",null,[i(s,{to:"#can-중재와-우선순위"},{default:e(()=>t[0]||(t[0]=[a("CAN 중재와 우선순위")])),_:1}),n("ul",null,[n("li",null,[i(s,{to:"#학습-목표"},{default:e(()=>t[1]||(t[1]=[a("학습 목표")])),_:1})]),n("li",null,[i(s,{to:"#_1-버스-중재-arbitration-란"},{default:e(()=>t[2]||(t[2]=[a("1. 버스 중재(Arbitration)란")])),_:1}),n("ul",null,[n("li",null,[i(s,{to:"#노드-id-가-아니라-메시지-id"},{default:e(()=>t[3]||(t[3]=[a('"노드 ID"가 아니라 "메시지 ID"')])),_:1})])])]),n("li",null,[i(s,{to:"#_2-비트-단위-중재-과정"},{default:e(()=>t[4]||(t[4]=[a("2. 비트 단위 중재 과정")])),_:1})]),n("li",null,[i(s,{to:"#_3-id-값과-우선순위-관계"},{default:e(()=>t[5]||(t[5]=[a("3. ID 값과 우선순위 관계")])),_:1}),n("ul",null,[n("li",null,[i(s,{to:"#priority가-같으면-어떻게-되는가"},{default:e(()=>t[6]||(t[6]=[a("Priority가 같으면 어떻게 되는가")])),_:1})])])]),n("li",null,[i(s,{to:"#_4-메시지-설계-시-고려사항"},{default:e(()=>t[7]||(t[7]=[a("4. 메시지 설계 시 고려사항")])),_:1})]),n("li",null,[i(s,{to:"#다음-챕터"},{default:e(()=>t[8]||(t[8]=[a("다음 챕터")])),_:1})])])])])]),t[9]||(t[9]=p(`<h1 id="can-중재와-우선순위" tabindex="-1"><a class="header-anchor" href="#can-중재와-우선순위"><span>CAN 중재와 우선순위</span></a></h1><h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>CAN 버스의 중재(Arbitration) 개념과 필요성을 설명할 수 있다</li><li>CSMA/CD+AMP 메커니즘의 동작 방식을 이해한다</li><li>비트 단위 중재 과정을 단계별로 추적할 수 있다</li><li>ID 값과 우선순위의 관계를 설명할 수 있다</li><li>안전 관련 메시지 설계 시 ID 배정 원칙을 적용할 수 있다</li></ul><hr><h2 id="_1-버스-중재-arbitration-란" tabindex="-1"><a class="header-anchor" href="#_1-버스-중재-arbitration-란"><span>1. 버스 중재(Arbitration)란</span></a></h2><p><strong>문제 상황<strong>: 여러 노드가 하나의 버스를 공유하는 CAN에서, 두 노드가 </strong>동시에 메시지를 전송하기 시작하면</strong> 어떻게 될까?</p><p>이더넷의 경우 충돌(Collision)이 발생하면 두 노드 모두 전송을 멈추고 임의의 시간 뒤 재전송한다. 이 방식은 충돌 후 데이터가 손실된다.</p><p><strong>CAN의 해답</strong>: CAN은 <strong>CSMA/CD+AMP</strong> 방식을 사용해 충돌 없이 우선순위가 높은 메시지가 이기도록 한다.</p><table><thead><tr><th>용어</th><th>의미</th></tr></thead><tbody><tr><td><strong>CSMA</strong> (Carrier Sense Multiple Access)</td><td>전송 전 버스가 사용 중인지 확인한다</td></tr><tr><td><strong>CD</strong> (Collision Detection)</td><td>전송 중 충돌(다른 신호)을 감지한다</td></tr><tr><td><strong>AMP</strong> (Arbitration on Message Priority)</td><td>메시지 우선순위에 따라 중재한다</td></tr></tbody></table><p><strong>핵심 차이<strong>: 이더넷은 충돌 후 </strong>모두 재전송<strong>하지만, CAN은 중재 패배 노드만 재전송한다. 승리한 노드는 전송을 </strong>중단 없이 계속</strong>한다.</p><div class="hint-container info"><p class="hint-container-title">Info</p><p>중재는 ID 필드 전송 구간에서만 일어난다. 중재에서 이긴 노드의 메시지는 데이터 손실 없이 그대로 버스에 전달된다.</p></div><h3 id="노드-id-가-아니라-메시지-id" tabindex="-1"><a class="header-anchor" href="#노드-id-가-아니라-메시지-id"><span>&quot;노드 ID&quot;가 아니라 &quot;메시지 ID&quot;</span></a></h3><p>한 가지 주의할 점이 있다. CAN에서 ID는 <strong>노드(장치)를 식별하는 것이 아니라 메시지의 종류를 식별한다.</strong> 하나의 ECU가 여러 종류의 메시지를 보낼 수 있으며, 각각 다른 ID를 가진다.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">엔진 ECU (하나의 노드)가 보내는 메시지들:</span>
