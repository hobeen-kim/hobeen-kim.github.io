...
​	그럼 이러한 '어떤어떤' 과정이 일어나기 위해 먼저 정해줘야 하는건 뭘까요? 바로 **어떤 객체**에 **무슨 로직**을 적용할 지입니다. 어때 **'어떤 객체'가 포인트컷(Pointcut) 을 의미하고 '무슨 로직'이 어드바이스(Advice)를 의미** 합니다.
...
![image-20230606122920302](../../images/0000-00-00-[Spring] Proxy 와 AOP/image-20230606122920302.png)
...
​	그리고 `@EnableAspectJAutoProxy` 을 통해 프록시 객체를 자동생성하도록 설정합니다.
