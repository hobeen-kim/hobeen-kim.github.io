import{_ as d,c as o,a as l,d as t,e as u,b as s,r as i,o as p,f as a}from"./app-DW00K3Mq.js";const c={},b={class:"table-of-contents"};function g(v,n){const r=i("Header"),e=i("router-link");return p(),o("div",null,[l(r),t("nav",b,[t("ul",null,[t("li",null,[l(e,{to:"#_1-왜-can만으로는-부족한가"},{default:s(()=>n[0]||(n[0]=[a("1. 왜 CAN만으로는 부족한가")])),_:1}),t("ul",null,[t("li",null,[l(e,{to:"#can은-데이터-전달만-담당한다"},{default:s(()=>n[1]||(n[1]=[a("CAN은 데이터 전달만 담당한다")])),_:1})]),t("li",null,[l(e,{to:"#택배-트럭과-물류-시스템-비유"},{default:s(()=>n[2]||(n[2]=[a("택배 트럭과 물류 시스템 비유")])),_:1})])])]),t("li",null,[l(e,{to:"#_2-상위-프로토콜-지도"},{default:s(()=>n[3]||(n[3]=[a("2. 상위 프로토콜 지도")])),_:1}),t("ul",null,[t("li",null,[l(e,{to:"#osi-7계층에서의-위치"},{default:s(()=>n[4]||(n[4]=[a("OSI 7계층에서의 위치")])),_:1})]),t("li",null,[l(e,{to:"#프로토콜별-적용-도메인"},{default:s(()=>n[5]||(n[5]=[a("프로토콜별 적용 도메인")])),_:1})])])]),t("li",null,[l(e,{to:"#_3-j1939이란"},{default:s(()=>n[6]||(n[6]=[a("3. J1939이란")])),_:1})]),t("li",null,[l(e,{to:"#_4-j1939과-can의-관계"},{default:s(()=>n[7]||(n[7]=[a("4. J1939과 CAN의 관계")])),_:1}),t("ul",null,[t("li",null,[l(e,{to:"#_29비트-can-id의-구조화"},{default:s(()=>n[8]||(n[8]=[a("29비트 CAN ID의 구조화")])),_:1})]),t("li",null,[l(e,{to:"#_29비트-id-예시-해석"},{default:s(()=>n[9]||(n[9]=[a("29비트 ID 예시 해석")])),_:1})])])]),t("li",null,[l(e,{to:"#_5-j1939-네트워크-구성"},{default:s(()=>n[10]||(n[10]=[a("5. J1939 네트워크 구성")])),_:1}),t("ul",null,[t("li",null,[l(e,{to:"#소스-어드레스-sa-할당"},{default:s(()=>n[11]||(n[11]=[a("소스 어드레스(SA) 할당")])),_:1})]),t("li",null,[l(e,{to:"#네트워크-토폴로지-예시"},{default:s(()=>n[12]||(n[12]=[a("네트워크 토폴로지 예시")])),_:1})]),t("li",null,[l(e,{to:"#j1939-통신-흐름-예시"},{default:s(()=>n[13]||(n[13]=[a("J1939 통신 흐름 예시")])),_:1})]),t("li",null,[l(e,{to:"#다음-챕터"},{default:s(()=>n[14]||(n[14]=[a("다음 챕터")])),_:1})])])])])]),n[15]||(n[15]=u(`<div class="hint-container info"><p class="hint-container-title">학습 목표</p><ul><li>CAN만으로 부족한 이유를 상위 프로토콜의 필요성과 연결해서 설명할 수 있다.</li><li>CANopen, DeviceNet, J1939, ISOBUS의 위치와 차이를 구분할 수 있다.</li><li>J1939의 29비트 CAN ID 구조(Priority, EDP, DP, PF, PS, SA)를 해석할 수 있다.</li><li>J1939 네트워크에서 소스 어드레스(SA)의 역할을 이해한다.</li></ul></div><h1 id="_1-왜-can만으로는-부족한가" tabindex="-1"><a class="header-anchor" href="#_1-왜-can만으로는-부족한가"><span>1. 왜 CAN만으로는 부족한가</span></a></h1><h2 id="can은-데이터-전달만-담당한다" tabindex="-1"><a class="header-anchor" href="#can은-데이터-전달만-담당한다"><span>CAN은 데이터 전달만 담당한다</span></a></h2><p>CAN 프로토콜은 물리 계층과 데이터 링크 계층만 정의한다. 메시지를 버스에 올리고 내리는 것, 에러를 감지하는 것 — 여기까지가 CAN이 하는 일이다.</p><p>다음 기능들은 CAN 규격 어디에도 없다.</p><table><thead><tr><th>필요 기능</th><th>CAN 2.0 지원 여부</th></tr></thead><tbody><tr><td>노드별 고유 주소 관리</td><td>없음 (29비트 ID를 자유롭게 사용)</td></tr><tr><td>메시지 의미 해석 (온도, 압력 등)</td><td>없음</td></tr><tr><td>8바이트 초과 데이터 전송 프로토콜</td><td>없음</td></tr><tr><td>네트워크 진단 / 장치 검색</td><td>없음</td></tr><tr><td>타임아웃, 재전송 정책</td><td>없음</td></tr></tbody></table><h2 id="택배-트럭과-물류-시스템-비유" tabindex="-1"><a class="header-anchor" href="#택배-트럭과-물류-시스템-비유"><span>택배 트럭과 물류 시스템 비유</span></a></h2><blockquote><p>&quot;CAN은 택배 트럭이고, J1939은 물류 시스템이다.&quot;</p></blockquote><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">CAN (택배 트럭)</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>J1939이 정의하는 것들:</p><ul><li><strong>PGN (Parameter Group Number)</strong>: 메시지 종류 식별자</li><li><strong>SPN (Suspect Parameter Number)</strong>: 데이터 필드 내 개별 파라미터 식별자</li><li><strong>소스/목적지 주소 관리</strong></li><li><strong>Transport Protocol</strong>: 8바이트 초과 데이터를 여러 프레임으로 분할 전송</li><li><strong>네트워크 관리</strong>: 주소 요청, 주소 충돌 감지</li></ul><h1 id="_4-j1939과-can의-관계" tabindex="-1"><a class="header-anchor" href="#_4-j1939과-can의-관계"><span>4. J1939과 CAN의 관계</span></a></h1><h2 id="_29비트-can-id의-구조화" tabindex="-1"><a class="header-anchor" href="#_29비트-can-id의-구조화"><span>29비트 CAN ID의 구조화</span></a></h2><p>Classic CAN 2.0B는 29비트 확장 ID를 제공하지만, 이 ID를 어떻게 쓸지는 규정하지 않는다. J1939은 이 29비트를 다음과 같이 <strong>명확한 필드로 구조화</strong>한다.</p><pre class="mermaid">packet-beta
  0-2: &quot;Priority (3 bit)&quot;
  3-3: &quot;EDP (1 bit)&quot;
  4-4: &quot;DP (1 bit)&quot;
...
<span class="line"></span>
<span class="line">hex → binary: 0x18FEE000 = 0001 1000 1111 1110 1110 0000 0000 0000 (32bit)</span>
<span class="line">하위 29비트:                 1 1000 1111 1110 1110 0000 0000 0000 (29bit)</span>
<span class="line"></span>
<span class="line">분해:</span>
<span class="line">  Priority : 110       = 6 (기본 우선순위)</span>
<span class="line">  EDP      : 0         = 0</span>
