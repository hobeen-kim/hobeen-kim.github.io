    ...
    sidebar: {
      ...
      '/study/keycloak/': [
        ...
        },
        {
          ...
          collapsible: false,
          children: [
            { text: 'CH2. Realm과 Organizations', link: '/study/keycloak/02-realm-organizations' },
            { text: 'CH3. Client와 Service Account', link: '/study/keycloak/03-client-service-account' },
            { text: 'CH4. 사용자와 자격 증명', link: '/study/keycloak/04-user-credentials' },
            { text: 'CH5. Role·Group과 Composite Role', link: '/study/keycloak/05-role-group' },
          ],
        },
        {
          text: '토큰·권한·프로토콜',
          collapsible: false,
          children: [
            { text: 'CH6. Client Scope와 Protocol Mapper', link: '/study/keycloak/06-protocol-mapper' },
            { text: 'CH7. Authorization Services와 UMA', link: '/study/keycloak/07-authz-uma' },
            { text: 'CH8. SAML 2.0과 Token Exchange', link: '/study/keycloak/08-saml-token-exchange' },
          ],
        },
        {
          text: '인증 정책과 플로우',
          collapsible: false,
          children: [
            { text: 'CH9. 인증 플로우 커스터마이징', link: '/study/keycloak/09-auth-flow' },
            { text: 'CH10. Password Policy와 Brute Force', link: '/study/keycloak/10-password-policy' },
            { text: 'CH11. MFA — TOTP / WebAuthn', link: '/study/keycloak/11-mfa' },
          ],
        },
        {
          text: '페더레이션',
          collapsible: false,
          children: [
            { text: 'CH12. User Federation (LDAP/AD)', link: '/study/keycloak/12-user-federation' },
            { text: 'CH13. Identity Brokering', link: '/study/keycloak/13-identity-brokering' },
          ],
        },
        {
          text: '커스터마이징 (SPI)',
          collapsible: false,
          children: [
            { text: 'CH14. SPI로 Keycloak 확장', link: '/study/keycloak/14-spi-overview' },
            { text: 'CH15. 커스텀 Authenticator', link: '/study/keycloak/15-custom-authenticator' },
            { text: 'CH16. 커스텀 User Storage', link: '/study/keycloak/16-custom-user-storage' },
            { text: 'CH17. Theme 커스터마이징', link: '/study/keycloak/17-theme' },
          ],
        },
        {
          text: '운영과 확장',
          collapsible: false,
          children: [
            { text: 'CH18. Infinispan HA 클러스터링', link: '/study/keycloak/18-ha-clustering' },
            { text: 'CH19. Kubernetes + Operator 배포', link: '/study/keycloak/19-k8s-operator' },
            { text: 'CH20. 데이터베이스와 성능', link: '/study/keycloak/20-database-performance' },
            { text: 'CH21. Admin REST API와 자동화', link: '/study/keycloak/21-admin-rest-api' },
            { text: 'CH22. Backup/Restore와 Realm 이관', link: '/study/keycloak/22-backup-restore' },
            { text: 'CH23. 모니터링·감사와 업그레이드', link: '/study/keycloak/23-monitoring-upgrade' },
          ],
        },
      ],
      '/study/oauth/': [
