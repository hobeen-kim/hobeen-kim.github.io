...
</pre><p><strong>CAN 표준 체계:</strong></p><table><thead><tr><th>표준</th><th>내용</th></tr></thead><tbody><tr><td>ISO 11898-1</td><td>데이터 링크 계층 (프레임 구조, 에러 처리)</td></tr><tr><td>ISO 11898-2</td><td>고속 물리 계층 (최대 1 Mbps)</td></tr><tr><td>ISO 11898-3</td><td>저속 내결함성 물리 계층 (최대 125 kbps)</td></tr><tr><td>ISO 11898-5</td><td>저전력 모드 (슬립/웨이크업)</td></tr></tbody></table><h2 id="_2-can을-쓰는-곳" tabindex="-1"><a class="header-anchor" href="#_2-can을-쓰는-곳"><span>2. CAN을 쓰는 곳</span></a></h2><p>CAN은 자동차에서 시작했지만, 지금은 훨씬 넓은 분야에서 사용된다.</p><pre class="mermaid">mindmap
  root((CAN 적용 분야))
    자동차
      엔진 제어
      ABS 브레이크
