...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-dominant-vs-recessive-—-wired-and-동작" tabindex="-1"><a class="header-anchor" href="#_2-dominant-vs-recessive-—-wired-and-동작"><span>2. Dominant vs Recessive — Wired-AND 동작</span></a></h2><h3 id="상태-정의" tabindex="-1"><a class="header-anchor" href="#상태-정의"><span>상태 정의</span></a></h3><ul><li><strong>Dominant (우세, 비트 0)</strong>: CAN_H=3.5V, CAN_L=1.5V, 전압 차 2V</li><li><strong>Recessive (열세, 비트 1)</strong>: CAN_H=CAN_L=2.5V, 전압 차 0V</li></ul><h3 id="wired-and란" tabindex="-1"><a class="header-anchor" href="#wired-and란"><span>Wired-AND란</span></a></h3><p>버스에 연결된 노드 중 <strong>단 하나라도 Dominant(0)</strong>를 보내면, 버스 전체가 Dominant가 된다. 모든 노드가 Recessive(1)를 보낼 때만 버스가 Recessive 상태가 된다.</p><p>논리식으로: <code>버스 상태 = 노드A AND 노드B AND 노드C AND ...</code><br> (0이 &quot;강한&quot; 값이므로, 하나라도 0이면 결과는 0)</p><p>이것이 중재(Arbitration) 메커니즘의 기반이다.</p><pre class="mermaid">flowchart TD
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>속도와 거리가 정해지면, 마지막으로 물리적인 연결 방법을 알아야 한다. CAN 장비를 실제로 연결할 때 사용하는 커넥터와 핀 배치를 살펴봅시다.</p><h2 id="_7-커넥터와-핀아웃" tabindex="-1"><a class="header-anchor" href="#_7-커넥터와-핀아웃"><span>7. 커넥터와 핀아웃</span></a></h2><h3 id="db9-커넥터-iso-11898-권장" tabindex="-1"><a class="header-anchor" href="#db9-커넥터-iso-11898-권장"><span>DB9 커넥터 (ISO 11898 권장)</span></a></h3><p>CAN 디버깅 장비나 PC 인터페이스에서 가장 많이 쓰이는 9핀 D-Sub 커넥터이다.</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">DB9 Female (장비 측)</span>
<span class="line"> ┌─────────────────────┐</span>
