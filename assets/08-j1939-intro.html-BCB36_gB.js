import{_ as r,c as o,a as s,b as t,d as u,f as l,r as i,o as p,e as a}from"./app-Bb56xpn1.js";const c={},v={class:"table-of-contents"};function h(A,n){const d=i("Header"),e=i("router-link");return p(),o("div",null,[s(d),t("nav",v,[t("ul",null,[t("li",null,[s(e,{to:"#_1-왜-can만으로는-부족한가"},{default:l(()=>n[0]||(n[0]=[a("1. 왜 CAN만으로는 부족한가")])),_:1}),t("ul",null,[t("li",null,[s(e,{to:"#can은-데이터-전달만-담당한다"},{default:l(()=>n[1]||(n[1]=[a("CAN은 데이터 전달만 담당한다")])),_:1})]),t("li",null,[s(e,{to:"#택배-트럭과-물류-시스템-비유"},{default:l(()=>n[2]||(n[2]=[a("택배 트럭과 물류 시스템 비유")])),_:1})])])]),t("li",null,[s(e,{to:"#_2-상위-프로토콜-지도"},{default:l(()=>n[3]||(n[3]=[a("2. 상위 프로토콜 지도")])),_:1}),t("ul",null,[t("li",null,[s(e,{to:"#osi-7계층에서의-위치"},{default:l(()=>n[4]||(n[4]=[a("OSI 7계층에서의 위치")])),_:1})]),t("li",null,[s(e,{to:"#프로토콜별-적용-도메인"},{default:l(()=>n[5]||(n[5]=[a("프로토콜별 적용 도메인")])),_:1})])])]),t("li",null,[s(e,{to:"#_3-j1939이란"},{default:l(()=>n[6]||(n[6]=[a("3. J1939이란")])),_:1})]),t("li",null,[s(e,{to:"#_4-j1939과-can의-관계"},{default:l(()=>n[7]||(n[7]=[a("4. J1939과 CAN의 관계")])),_:1}),t("ul",null,[t("li",null,[s(e,{to:"#_29비트-can-id의-구조화"},{default:l(()=>n[8]||(n[8]=[a("29비트 CAN ID의 구조화")])),_:1})]),t("li",null,[s(e,{to:"#_29비트-id-예시-해석"},{default:l(()=>n[9]||(n[9]=[a("29비트 ID 예시 해석")])),_:1})])])]),t("li",null,[s(e,{to:"#_5-j1939-네트워크-구성"},{default:l(()=>n[10]||(n[10]=[a("5. J1939 네트워크 구성")])),_:1}),t("ul",null,[t("li",null,[s(e,{to:"#소스-어드레스-sa-할당"},{default:l(()=>n[11]||(n[11]=[a("소스 어드레스(SA) 할당")])),_:1})]),t("li",null,[s(e,{to:"#네트워크-토폴로지-예시"},{default:l(()=>n[12]||(n[12]=[a("네트워크 토폴로지 예시")])),_:1})]),t("li",null,[s(e,{to:"#j1939-통신-흐름-예시"},{default:l(()=>n[13]||(n[13]=[a("J1939 통신 흐름 예시")])),_:1})]),t("li",null,[s(e,{to:"#다음-챕터"},{default:l(()=>n[14]||(n[14]=[a("다음 챕터")])),_:1})])])])])]),n[15]||(n[15]=u(`<div class="hint-container info"><p class="hint-container-title">학습 목표</p><ul><li>CAN만으로 부족한 이유를 상위 프로토콜의 필요성과 연결해서 설명할 수 있다.</li><li>CANopen, DeviceNet, J1939, ISOBUS의 위치와 차이를 구분할 수 있다.</li><li>J1939의 29비트 CAN ID 구조(Priority, EDP, DP, PF, PS, SA)를 해석할 수 있다.</li><li>J1939 네트워크에서 소스 어드레스(SA)의 역할을 이해한다.</li></ul></div><hr><h1 id="_1-왜-can만으로는-부족한가" tabindex="-1"><a class="header-anchor" href="#_1-왜-can만으로는-부족한가"><span>1. 왜 CAN만으로는 부족한가</span></a></h1><h2 id="can은-데이터-전달만-담당한다" tabindex="-1"><a class="header-anchor" href="#can은-데이터-전달만-담당한다"><span>CAN은 데이터 전달만 담당한다</span></a></h2><p>CAN 프로토콜은 물리 계층과 데이터 링크 계층만 정의한다. 메시지를 버스에 올리고 내리는 것, 에러를 감지하는 것 — 여기까지가 CAN이 하는 일이다.</p><p>다음 기능들은 CAN 규격 어디에도 없다.</p><table><thead><tr><th>필요 기능</th><th>CAN 2.0 지원 여부</th></tr></thead><tbody><tr><td>노드별 고유 주소 관리</td><td>없음 (29비트 ID를 자유롭게 사용)</td></tr><tr><td>메시지 의미 해석 (온도, 압력 등)</td><td>없음</td></tr><tr><td>8바이트 초과 데이터 전송 프로토콜</td><td>없음</td></tr><tr><td>네트워크 진단 / 장치 검색</td><td>없음</td></tr><tr><td>타임아웃, 재전송 정책</td><td>없음</td></tr></tbody></table><h2 id="택배-트럭과-물류-시스템-비유" tabindex="-1"><a class="header-anchor" href="#택배-트럭과-물류-시스템-비유"><span>택배 트럭과 물류 시스템 비유</span></a></h2><blockquote><p>&quot;CAN은 택배 트럭이고, J1939은 물류 시스템이다.&quot;</p></blockquote><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">CAN (택배 트럭)</span>
