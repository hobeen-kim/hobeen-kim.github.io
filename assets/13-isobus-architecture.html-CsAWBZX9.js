import{_ as n,c as e,d as r,o as a}from"./app-C19JOZcM.js";const s={};function o(l,t){return a(),e("div",null,t[0]||(t[0]=[r(`<h1 id="isobus-네트워크-아키텍처" tabindex="-1"><a class="header-anchor" href="#isobus-네트워크-아키텍처"><span>ISOBUS 네트워크 아키텍처</span></a></h1><h2 id="학습-목표" tabindex="-1"><a class="header-anchor" href="#학습-목표"><span>학습 목표</span></a></h2><ul><li>ISOBUS 네트워크가 In-Cab 버스와 Implement 버스로 구분되는 이유를 설명할 수 있다.</li><li>TBC(Tractor Bus Connector)의 역할과 핀 구성을 이해한다.</li><li>ISOBUS 상의 주요 ECU 종류와 각 역할을 구분할 수 있다.</li><li>장비 시동 후 ISOBUS 통신이 확립되기까지의 메시지 흐름을 순서대로 설명할 수 있다.</li></ul><hr><h2 id="_1-네트워크-토폴로지" tabindex="-1"><a class="header-anchor" href="#_1-네트워크-토폴로지"><span>1. 네트워크 토폴로지</span></a></h2><p>ISOBUS 네트워크는 물리적으로 두 개의 CAN 버스로 구성된다.</p><ul><li><strong>In-Cab 버스</strong>: 트랙터 내부 ECU들이 연결되는 버스</li><li><strong>Implement 버스</strong>: 트랙터 외부에 연결되는 작업기 ECU들이 연결되는 버스</li></ul><p>두 버스는 <strong>TBC(Tractor Bus Connector)</strong>를 통해 연결된다.</p><pre class="mermaid">graph LR
    subgraph 트랙터_내부
        TECU[TECU\\nTractor ECU]
        VT[VT\\nVirtual Terminal]
        TC[TC\\nTask Controller]
...
</pre><p>각 단계의 의미:</p><ol><li><strong>주소 클레임</strong>: 모든 ECU가 네트워크에서 고유한 주소를 확보한다 (J1939 방식과 동일).</li><li><strong>Working Set 구성</strong>: 작업기를 대표하는 WSM이 자신과 멤버 ECU를 선언한다.</li><li><strong>VT 연결</strong>: WSM이 VT에 연결을 요청하고 상태를 수신한다.</li><li><strong>Object Pool 전송</strong>: 작업기 UI 화면 데이터를 VT에 업로드한다.</li><li><strong>Device Descriptor 전송</strong>: 작업기의 기능 구조를 TC에 알립니다.</li><li><strong>정상 동작</strong>: TECU 정보·TC 명령·VT 화면 업데이트가 주기적으로 이루어집니다.</li></ol><hr><blockquote><p><strong>핵심 정리</strong></p><ul><li>ISOBUS 네트워크는 In-Cab 버스와 Implement 버스로 분리되며, TBC 9핀 커넥터로 연결된다.</li><li>VT는 화면, TC는 작업 관리, TECU는 트랙터 정보 제공, WSM은 작업기 대표 역할을 한다.</li><li>시동 후 주소 클레임 → Working Set 구성 → VT 연결 → Object Pool 전송 순으로 통신이 확립된다.</li><li>Object Pool은 작업기 UI를 정의하는 데이터로, WSM이 VT에 전송하여 화면을 구성한다.</li></ul></blockquote><hr><h2 id="다음-챕터" tabindex="-1"><a class="header-anchor" href="#다음-챕터"><span>다음 챕터</span></a></h2><ul><li>다음 : <a href="/study/isobus/14-isobus-network-mgmt">ISOBUS 네트워크 관리</a></li></ul>`,34)]))}const i=n(s,[["render",o],["__file","13-isobus-architecture.html.vue"]]),C=JSON.parse('{"path":"/study/isobus/13-isobus-architecture.html","title":"ISOBUS 네트워크 아키텍처","lang":"en-US","frontmatter":{"title":"ISOBUS 네트워크 아키텍처","description":"ISOBUS 네트워크의 물리적 토폴로지, TBC 커넥터, ECU 종류, 메시지 흐름 순서를 이해한다.","date":"2026-04-13T00:00:00.000Z","tags":["ISOBUS","ISO11783","TBC","VT","TaskController","ECU"],"prev":"/study/isobus/12-isobus-overview","next":"/study/isobus/14-isobus-network-mgmt"},"headers":[{"level":1,"title":"ISOBUS 네트워크 아키텍처","slug":"isobus-네트워크-아키텍처","link":"#isobus-네트워크-아키텍처","children":[{"level":2,"title":"학습 목표","slug":"학습-목표","link":"#학습-목표","children":[]},{"level":2,"title":"1. 네트워크 토폴로지","slug":"_1-네트워크-토폴로지","link":"#_1-네트워크-토폴로지","children":[]},{"level":2,"title":"2. TBC (Tractor Bus Connector)","slug":"_2-tbc-tractor-bus-connector","link":"#_2-tbc-tractor-bus-connector","children":[{"level":3,"title":"9핀 커넥터 핀 배치","slug":"_9핀-커넥터-핀-배치","link":"#_9핀-커넥터-핀-배치","children":[]},{"level":3,"title":"전원 공급 구조","slug":"전원-공급-구조","link":"#전원-공급-구조","children":[]}]},{"level":2,"title":"3. ECU 종류","slug":"_3-ecu-종류","link":"#_3-ecu-종류","children":[{"level":3,"title":"각 ECU의 핵심 역할 요약","slug":"각-ecu의-핵심-역할-요약","link":"#각-ecu의-핵심-역할-요약","children":[]}]},{"level":2,"title":"4. 네트워크 메시지 흐름","slug":"_4-네트워크-메시지-흐름","link":"#_4-네트워크-메시지-흐름","children":[]},{"level":2,"title":"다음 챕터","slug":"다음-챕터","link":"#다음-챕터","children":[]}]}],"git":{},"filePathRelative":"_study/isobus/13-isobus-architecture.md"}');export{i as comp,C as data};
